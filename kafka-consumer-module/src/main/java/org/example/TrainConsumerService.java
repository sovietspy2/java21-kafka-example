...
public class TrainConsumerService {
    private static final Logger LOGGER = LoggerFactory.getLogger(TrainConsumerService.class);
    ...
    @KafkaListener(topics = "train", groupId = "testGroup1", containerFactory = "kafkaTrainMessageListenerFactory", properties = { "auto.offset.reset=earliest" })
